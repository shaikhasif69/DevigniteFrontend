...
class MyApp extends StatefulWidget {
  ...
  @override
  State<MyApp> createState() => _SpeechSampleAppState();
}

/// An example that demonstrates the basic functionality of the
/// SpeechToText plugin for using the speech recognition capability
/// of the underlying platform.
class _SpeechSampleAppState extends State<MyApp> {
  static bool _hasSpeech = false;
  static bool _logEvents = false;
  static bool _onDevice = false;
  static final TextEditingController _pauseForController =
